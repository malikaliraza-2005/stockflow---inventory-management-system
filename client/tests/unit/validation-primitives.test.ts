 ...
 * T-a task, not here.
 *
 * TWIN: server/tests/unit/validation-primitives.test.ts runs the same vectors
 * against the server module — parity is enforced by tests, not discipline.
 */
...
import {
  ...
  uuid,
  validationMessages,
} from '../../src/lib/validation/primitives';
